  ...
  subcategories: [
    {
      ...
      courses: [
        { title: 'Gestion de flotte dans les opérations minières', id: 'gestion-flotte-operations' },
        { title: 'Suivi et optimisation de la consommation de carburant', id: 'optimisation-carburant' },
        { title: 'Gestion du cycle de vie des pneus pour engins lourds', id: 'gestion-pneus' },
        { title: 'Planification des itinéraires et horaires en mines à ciel ouvert', id: 'planification-itineraires' },
        { title: 'Planification de la maintenance et réduction des arrêts', id: 'planification-maintenance' },
      ]
    },
    {
      id: 'systems',
      ...
      courses: [
        { title: 'Fondamentaux des systèmes de gestion de flotte (FMS)', id: 'fondamentaux-fms' },
        { title: 'CMMS (GMAO) pour les mines', id: 'cmms-mines' },
        { title: 'Introduction à l'ERP minier (SAP, Oracle, etc.)', id: 'erp-minier' },
        { title: 'Intégration FMS, CMMS, ERP & outils de planification minière', id: 'integration-systemes' },
        { title: 'Télématique, IoT et données temps réel en logistique minière', id: 'telematique-iot' },
        { title: 'Analytique minière et systèmes d'aide à la décision', id: 'analytique-miniere' },
      ]
    },
    {
      id: 'leadership',
      ...
      courses: [
        { title: 'Leadership et supervision des opérations minières', id: 'leadership-operations' },
        { title: 'Lean Mining et amélioration continue', id: 'lean-mining' },
        { title: 'KPIs miniers et tableaux de bord opérationnels', id: 'kpis-tableaux-bord' },
        { title: 'Gestion du changement dans les organisations minières', id: 'gestion-changement' },
        { title: 'Formation du personnel et développement des talents', id: 'formation-personnel' },
      ]
    },
  ]
}; 
