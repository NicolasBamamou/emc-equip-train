export const softSkillsSpecialization = {
  ...
  courses: [
    ...
    },
    {
      ...
      description: "Développez votre capacité à prendre des initiatives et à résoudre des problèmes de manière autonome et créative.",
      topics: [
      ...
      certification: "Certificat d'Initiative et Résolution de Problèmes"
    }
  ],
  subcategories: [
    {
      ...
      courses: [
        { title: 'Communication professionnelle (orale & écrite)', id: 'communication-professionnelle' },
        { title: 'Anglais technique pour la mine', id: 'anglais-technique-mine' },
        { title: 'Rédaction de rapports et documentation', id: 'redaction-rapports' },
        { title: 'Communication interpersonnelle au travail', id: 'communication-interpersonnelle' },
        { title: 'Résolution de conflits et culture du feedback', id: 'resolution-conflits' },
      ]
    },
    {
      id: 'digital',
      ...
      courses: [
        { title: 'Culture informatique de base (email, fichiers, Excel, PDF)', id: 'culture-informatique-base' },
        { title: 'Outils digitaux pour la mine (tablettes FMS, ERP, applis sécurité)', id: 'outils-digitaux-mine' },
        { title: 'Saisie de données, formulaires numériques et rapports miniers', id: 'saisie-donnees-rapports' },
        { title: 'Introduction à Microsoft Office / Google Workspace', id: 'microsoft-office' },
        { title: 'Bases de cybersécurité & étiquette digitale', id: 'cybersecurite-etiquette' },
      ]
    },
    {
      id: 'professional',
      ...
      courses: [
        { title: 'Éthique et responsabilité au travail', id: 'ethique-responsabilite' },
        { title: 'Travail d'équipe et collaboration sur le terrain', id: 'travail-equipe-terrain' },
        { title: 'Gestion du temps et planification des shifts', id: 'gestion-temps-shifts' },
        { title: 'Comportement professionnel et intelligence émotionnelle', id: 'comportement-intelligence-emotionnelle' },
        { title: 'Adaptabilité et apprentissage en situation de travail', id: 'adaptabilite-apprentissage' },
      ]
    },
    {
      id: 'leadership',
      ...
      courses: [
        { title: 'Bases du leadership pour superviseurs', id: 'bases-leadership-superviseurs' },
        { title: 'Prise d'initiative et résolution de problèmes', id: 'initiative-resolution-problemes' },
      ]
    },
  ]
}; 
