  ...
  subcategories: [
    {
      ...
      courses: [
        { title: 'Introduction au génie minier', id: 'intro-genie-minier' },
        { title: 'Méthodes d'exploitation minière (surface & souterraine)', id: 'methodes-exploitation' },
        { title: 'Bases de géologie et mécanique des roches', id: 'geologie-mecanique' },
        { title: 'Terminologie et opérations minières', id: 'terminologie-operations' },
        { title: 'Sécurité minière et considérations environnementales', id: 'securite-environnement' },
      ]
    },
    {
      id: 'intermediate',
      ...
      courses: [
        { title: 'Topographie et cartographie minière', id: 'topographie-cartographie' },
        { title: 'Conception de mines et planification de l'aménagement', id: 'conception-planification' },
        { title: 'Techniques de forage et de minage', id: 'forage-minage' },
        { title: 'Systèmes de manutention et de transport des matériaux', id: 'manutention-transport' },
        { title: 'Économie minière et études de faisabilité', id: 'economie-faisabilite' },
        { title: 'Sélection et optimisation des équipements miniers', id: 'selection-equipements' },
      ]
    },
    {
      id: 'advanced',
      ...
      courses: [
        { title: 'Formation aux logiciels de planification minière (Surpac, Datamine, Micromine, MineSched)', id: 'logiciels-planification' },
        { title: 'Conception et optimisation de mines à ciel ouvert', id: 'mines-ciel-ouvert' },
        { title: 'Conception de mines souterraines et planification de la ventilation', id: 'mines-souterraines' },
        { title: 'Stabilité des pentes et systèmes de soutènement', id: 'stabilite-pentes' },
        { title: 'Gestion des opérations minières', id: 'gestion-operations' },
        { title: 'Planification de la fermeture et de la réhabilitation des mines', id: 'fermeture-rehabilitation' },
      ]
    },
  ]
}; 