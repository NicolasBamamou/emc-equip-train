...
import { Clock, Users, Book, ArrowLeft, Droplets, Wrench, CheckCircle } from 'lucide-react';

const SystemesAlimPage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      
      {/* Hero Section - Fuel Systems Theme */}
        ...
        <div className="container mx-auto px-4 py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-cyan-100 mb-8 leading-relaxed">
              Maîtrisez les systèmes d'injection et d'alimentation diesel
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Certification Technique</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <Card className="border-cyan-200">
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed">
                    Formation spécialisée sur les systèmes d'alimentation en carburant des moteurs diesel. 
                    Apprenez le fonctionnement, la maintenance et la réparation des systèmes d'injection 
                    modernes et conventionnels.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-cyan-200">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {[
                      "Test de pression et de débit",
                      "Démontage et remontage d'injecteurs",
                      "Calibration des pompes d'injection",
                      "Utilisation d'appareils de test spécialisés"
                    ].map((skill, index) => (
              ...
              <Card className="border-cyan-200 shadow-lg">
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-cyan-600 mb-2">2.100.000FG</div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">Systèmes Carburant</span>
                    </div>
                  </div>
              ...
              <Card className="border-cyan-200">
                ...
                <CardContent>
                  <ul className="space-y-2 text-gray-700">
                    <li>• Formation moteur de base</li>
                    <li>• Connaissance des outils</li>
...
export default SystemesAlimPage;
