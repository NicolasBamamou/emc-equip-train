...
import { ArrowLeft, Clock, Users, Award, CheckCircle, Heart } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative min-h-[400px] flex items-center bg-gradient-to-r from-red-700 to-pink-600">
          <div className="absolute inset-0 z-0">
            <img
              src="./images/teaminfo.jpg"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-white">
              <Link to="/courses" className="inline-flex items-center text-white hover:text-pink-200 mb-4">
              ...
              <p className="text-xl md:text-2xl mb-8 leading-relaxed">
                Apprenez les gestes qui sauvent et maîtrisez les procédures d'urgence 
                essentielles en milieu minier.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center bg-white bg-opacity-20 backdrop-blur rounded-full px-6 py-3">
                  ...
                  <span className="font-semibold">1.300.000 FG</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="grid lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2">
                  ...
                  <p className="text-xl leading-relaxed mb-6 text-gray-700">
                    Formation certifiante aux premiers secours et procédures d'urgence 
                    adaptées aux spécificités de l'industrie minière.
                  </p>

                  <div className="bg-red-50 rounded-xl p-8 mb-12">
                    <h3 className="text-2xl font-bold mb-6 text-red-900 flex items-center">
                      <CheckCircle className="w-6 h-6 mr-3 text-red-600" />
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-gray-600">1.300.000 FG</div>
                          </div>
                        </div>
                      </div>
                    </div>
