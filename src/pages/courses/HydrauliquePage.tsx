...
import { ArrowLeft, Droplets, Zap, Gauge, CheckCircle, PlayCircle, Award, Clock, BookOpen, Target, Lightbulb, TrendingUp } from 'lucide-react';
import { Card, CardHeader, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Separator } from '@/components/ui/separator';

const HydrauliquePage = () => {
  return (
        ...
        <div className="relative container mx-auto px-4 py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Maîtrisez la conception, la maintenance et la réparation des systèmes hydrauliques. Formation complète sur 
              les vérins, pompes, distributeurs et circuits hydrauliques des engins lourds miniers.
            </p>
                  ...
                  <CardHeader className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-t-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100">Formation spécialisée en hydraulique</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-8">
                    <div className="space-y-6">
                      <p className="text-gray-700 text-lg leading-relaxed">
                        Cette formation spécialisée vous initie aux systèmes hydrauliques des engins lourds. Apprenez à 
                        comprendre, diagnostiquer et réparer les vérins, pompes, distributeurs et circuits hydrauliques 
                        pour assurer un fonctionnement optimal des équipements miniers.
                      </p>
                      
                      <div className="grid md:grid-cols-2 gap-6">
                        {[
                          { icon: Droplets, title: "Vérins Hydrauliques", desc: "Systèmes de levage et piston", color: "text-blue-600" },
                          { icon: Zap, title: "Pompes et Moteurs", desc: "Génération de puissance hydraulique", color: "text-indigo-600" },
                          { icon: TrendingUp, title: "Distributeurs", desc: "Contrôle de flux et direction", color: "text-purple-600" },
                          { icon: Gauge, title: "Circuits Hydrauliques", desc: "Schémas et systèmes complets", color: "text-blue-700" }
                        ].map((item, index) => (
                ...
                <Card className="border-none shadow-2xl mt-8 overflow-hidden bg-gradient-to-br from-white to-purple-50/50">
                  ...
                  <CardContent className="p-8">
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6">
                      <div className="space-y-6">
                        {[
                          { day: "Jour 1-2", topic: "Principes de base de l'hydraulique", details: "Lois physiques et propriétés des fluides" },
                          { day: "Jour 3-4", topic: "Composants hydrauliques", details: "Vérins, pompes, moteurs et distributeurs" },
                          { day: "Jour 5-6", topic: "Circuits et schémas hydrauliques", details: "Lecture de plans et dépannage" },
                          { day: "Jour 7", topic: "Maintenance et réparation", details: "Procédures de maintenance préventive" }
                        ].map((module, index) => (
                  ...
                  <CardHeader className="bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100">Systèmes Engins Lourds</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-gray-700">Attestation systèmes hydrauliques</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span className="text-sm text-gray-700">Compétences en maintenance hydraulique</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span className="text-sm text-gray-700">Diagnostic et réparation</span>
                      </div>
                    </div>
                    <Separator className="bg-gradient-to-r from-blue-200 to-indigo-200 my-4" />
                    <div className="text-center">
                      <p className="text-sm text-gray-600 mb-4">
                        Maîtrisez la puissance hydraulique
                      </p>
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Optimisez les performances des engins</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-purple-600 mt-0.5 flex-shrink-0" />
                        <span>Réduisez les temps d'arrêt machine</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-purple-600 mt-0.5 flex-shrink-0" />
                        <span>Maîtrisez les systèmes de puissance</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-purple-600 mt-0.5 flex-shrink-0" />
                        <span>Devenez expert en hydraulique</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
...
export default HydrauliquePage;
