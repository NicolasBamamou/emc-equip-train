...
import { ArrowLeft, Search, Bug, Zap, CheckCircle, PlayCircle, Award, Clock, BookOpen, Target, Lightbulb, TrendingUp } from 'lucide-react';
import { Card, CardHeader, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Separator } from '@/components/ui/separator';

const DiagnosticElectriquePage = () => {
  return (
        ...
        <div className="relative container mx-auto px-4 py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-slate-100 mb-8 leading-relaxed">
              Développez une expertise en diagnostic électrique et apprenez les méthodes systématiques 
              de recherche et résolution de pannes dans les environnements industriels complexes.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center bg-white/10 rounded-full px-6 py-3 backdrop-blur-sm">
                <Bug className="w-5 h-5 mr-2 text-slate-200" />
                  ...
                  <CardHeader className="bg-gradient-to-r from-slate-600 to-gray-600 text-white rounded-t-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-100">Formation en diagnostic électrique</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-8">
                    <div className="space-y-6">
                      <p className="text-gray-700 text-lg leading-relaxed">
                        Cette formation avancée vous forme aux techniques de diagnostic électrique les plus efficaces. 
                        Apprenez la méthodologie systématique de recherche de pannes, l'utilisation d'outils de 
                        diagnostic avancés et l'analyse des défaillances électriques en environnement minier.
                      </p>
                      
                      <div className="grid md:grid-cols-2 gap-6">
                        {[
                          { icon: Search, title: "Méthodologie Diagnostic", desc: "Approche systématique", color: "text-slate-600" },
                          { icon: Bug, title: "Outils Avancés", desc: "Équipements de diagnostic", color: "text-gray-600" },
                          { icon: Zap, title: "Analyse Défaillances", desc: "Défauts électriques", color: "text-zinc-600" },
                          { icon: TrendingUp, title: "Cas Pratiques", desc: "Environnement minier", color: "text-slate-700" }
                        ].map((item, index) => (
                ...
                <Card className="border-none shadow-2xl mt-8 overflow-hidden bg-gradient-to-br from-white to-zinc-50/50">
                  ...
                  <CardContent className="p-8">
                    <div className="bg-gradient-to-r from-gray-50 to-zinc-50 rounded-xl p-6">
                      <div className="space-y-6">
                        {[
                          { week: "Semaine 1", topic: "Méthodologie Diagnostic", details: "Approches systématiques et logiques" },
                          { week: "Semaine 2", topic: "Outils Avancés", details: "Équipements modernes de diagnostic" },
                          { week: "Semaine 3", topic: "Analyse Défaillances", details: "Types de pannes et solutions" },
                          { week: "Semaine 4", topic: "Cas d'Étude", details: "Projets pratiques en environnement minier" }
                        ].map((module, index) => (
                  ...
                  <CardHeader className="bg-gradient-to-br from-slate-600 to-gray-600 text-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-100">Électrique Avancé</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-gray-700">Certificat diagnostic électrique avancé</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span className="text-sm text-gray-700">Expert recherche de pannes</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span className="text-sm text-gray-700">Analyse défaillances</span>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Expertise très recherchée</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-zinc-600 mt-0.5 flex-shrink-0" />
...
export default DiagnosticElectriquePage;
