...
import { ArrowLeft, Map, Compass, Calculator, Ruler, CheckCircle, PlayCircle, Award, Clock, BookOpen, Target, Lightbulb, TrendingUp } from 'lucide-react';
import { Card, CardHeader, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Separator } from '@/components/ui/separator';

const TopographieCartographiePage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50">
        ...
        <div className="relative container mx-auto px-4 py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-amber-100 mb-8 leading-relaxed">
              Apprenez les techniques de levé topographique et de cartographie spécifiques aux mines. 
              Maîtrisez les instruments de mesure et les calculs de volumes essentiels.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center bg-white/10 rounded-full px-6 py-3 backdrop-blur-sm">
                <Compass className="w-5 h-5 mr-2 text-amber-200" />
                <span className="font-semibold">Intermédiaire</span>
              </div>
              <div className="flex items-center bg-white/10 rounded-full px-6 py-3 backdrop-blur-sm">
                <Award className="w-5 h-5 mr-2 text-amber-200" />
                <span className="font-semibold">2.300.000FG</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Main Content */}
      <main className="flex-1 bg-gradient-to-br from-amber-50 to-orange-50/30">
                  ...
                  <CardHeader className="bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-t-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-amber-100">Formation en topographie minière</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-8">
                    <div className="space-y-6">
                      <p className="text-gray-700 text-lg leading-relaxed">
                        Cette formation technique vous apprend les méthodes de levé topographique spécifiques 
                        aux sites miniers. Utilisez les instruments de précision, créez des cartes numériques 
                        et maîtrisez les calculs de volumes pour l'estimation des réserves.
                      </p>
                      
                      <div className="grid md:grid-cols-2 gap-6">
                        {[
                          { icon: Compass, title: "Instruments", desc: "Théodolites, GPS, stations", color: "text-amber-600" },
                          { icon: Map, title: "Levés Topographiques", desc: "Techniques de terrain", color: "text-orange-600" },
                          { icon: Calculator, title: "Cartographie SIG", desc: "Cartes numériques", color: "text-yellow-600" },
                          { icon: TrendingUp, title: "Calculs Volumes", desc: "Cubatures et réserves", color: "text-amber-700" }
                        ].map((item, index) => (
                ...
                <Card className="border-none shadow-2xl mt-8 overflow-hidden bg-gradient-to-br from-white to-yellow-50/50">
                  ...
                  <CardContent className="p-8">
                    <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl p-6">
                      <div className="space-y-6">
                        {[
                          { week: "Semaine 1", topic: "Instruments de Mesure", details: "Utilisation théodolites, GPS et stations totales" },
                          { week: "Semaine 2", topic: "Levés en Mine", details: "Techniques spécifiques aux sites miniers" },
                          { week: "Semaine 3", topic: "Cartographie & Calculs", details: "SIG, cartes numériques et calculs de volumes" }
                        ].map((module, index) => (
                  ...
                  <CardHeader className="bg-gradient-to-br from-amber-600 to-orange-600 text-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-amber-100">Minière</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-gray-700">Certificat topographie minière</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-amber-600" />
                        <span className="text-sm text-gray-700">Expert instruments de mesure</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-amber-600" />
                        <span className="text-sm text-gray-700">Spécialiste SIG et cartographie</span>
                      </div>
                    </div>
                    <Separator className="bg-gradient-to-r from-amber-200 to-orange-200 my-4" />
                    <div className="text-center">
                      <p className="text-sm text-gray-600 mb-4">
                        Cartographiez avec précision
                      </p>
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Base de toute planification</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-yellow-600 mt-0.5 flex-shrink-0" />
                        <span>Précision des mesures</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-yellow-600 mt-0.5 flex-shrink-0" />
                        <span>Estimation des réserves</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-yellow-600 mt-0.5 flex-shrink-0" />
                        <span>Contrôle de la production</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
...
export default TopographieCartographiePage;
