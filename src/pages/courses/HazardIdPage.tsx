...
import { ArrowLeft, Clock, Users, Award, CheckCircle, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative min-h-[400px] flex items-center bg-gradient-to-r from-red-900 to-orange-700">
          <div className="absolute inset-0 z-0">
            <img
              src="./images/work.jpg"
              alt="Identification des Dangers"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-white">
              ...
              <div className="flex items-center mb-4">
                <AlertTriangle className="w-12 h-12 mr-4 text-orange-300" />
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                Identification des Dangers sur le Lieu de Travail
              </h1>
              
              <p className="text-xl md:text-2xl mb-8 leading-relaxed">
                Développez vos compétences pour identifier, évaluer et signaler les dangers 
                potentiels dans l'environnement minier.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center bg-white bg-opacity-20 backdrop-blur rounded-full px-6 py-3">
                  ...
                  <span className="font-semibold">1.500.000 FG</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="grid lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2">
                  ...
                  <p className="text-xl leading-relaxed mb-6 text-gray-700">
                    Apprenez à reconnaître et évaluer les risques pour prévenir les accidents 
                    et créer un environnement de travail plus sûr.
                  </p>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-gray-600">1.500.000 FG</div>
                          </div>
                        </div>
                      </div>
                    </div>
