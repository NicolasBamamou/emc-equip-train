...
import { ArrowLeft, Cog, Wrench, BarChart3, Settings, CheckCircle, PlayCircle, Award, Clock, BookOpen, Target, Lightbulb, TrendingUp } from 'lucide-react';
import { Card, CardHeader, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Separator } from '@/components/ui/separator';

const SelectionEquipementsPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50">
      <Header />
      
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-violet-700 to-purple-800 text-white">
        ...
        <div className="relative container mx-auto px-4 py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-violet-100 mb-8 leading-relaxed">
              Choisissez et optimisez les équipements adaptés aux opérations minières spécifiques. 
              Maîtrisez le dimensionnement de flotte et l'optimisation des performances.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center bg-white/10 rounded-full px-6 py-3 backdrop-blur-sm">
                <Cog className="w-5 h-5 mr-2 text-violet-200" />
                  ...
                  <CardHeader className="bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-t-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-violet-100">Formation en sélection d'équipements</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-8">
                    <div className="space-y-6">
                      <p className="text-gray-700 text-lg leading-relaxed">
                        Cette formation technique vous apprend les critères de sélection des équipements miniers 
                        adaptés aux conditions spécifiques. Maîtrisez le dimensionnement optimal de flotte, 
                        l'optimisation des performances et l'analyse des coûts d'exploitation et maintenance.
                      </p>
                      
                      <div className="grid md:grid-cols-2 gap-6">
                        {[
                          { icon: Settings, title: "Critères Sélection", desc: "Choix technologiques", color: "text-violet-600" },
                          { icon: BarChart3, title: "Dimensionnement", desc: "Taille optimale de flotte", color: "text-purple-600" },
                          { icon: TrendingUp, title: "Optimisation", desc: "Performance maximale", color: "text-indigo-600" },
                          { icon: Wrench, title: "Coûts Exploitation", desc: "TCO et maintenance", color: "text-violet-700" }
                        ].map((item, index) => (
                ...
                <Card className="border-none shadow-2xl mt-8 overflow-hidden bg-gradient-to-br from-white to-indigo-50/50">
                  ...
                  <CardContent className="p-8">
                    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6">
                      <div className="space-y-6">
                        {[
                          { week: "Semaine 1", topic: "Critères de Sélection", details: "Analyse besoins et choix technologiques" },
                          { week: "Semaine 2", topic: "Dimensionnement Flotte", details: "Calculs capacité et optimisation taille" },
                          { week: "Semaine 3", topic: "Performances & Coûts", details: "Optimisation et analyse TCO" }
                        ].map((module, index) => (
                          <div key={index} className="flex items-start gap-4">
                            <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center text-white font-bold">
                              {index + 1}
                            </div>
                  ...
                  <CardHeader className="bg-gradient-to-br from-violet-600 to-purple-600 text-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-violet-100">Équipements</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-gray-700">Certificat sélection d'équipements</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-violet-600" />
                        <span className="text-sm text-gray-700">Expert dimensionnement flotte</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-violet-600" />
                        <span className="text-sm text-gray-700">Spécialiste optimisation TCO</span>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Investissements optimisés</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-indigo-600 mt-0.5 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-indigo-600 mt-0.5 flex-shrink-0" />
                        <span>Compétitivité renforcée</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
...
export default SelectionEquipementsPage;
