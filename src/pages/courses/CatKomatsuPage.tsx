...
import { ArrowLeft, Wrench, Building, Factory, CheckCircle, PlayCircle, Award, Clock, BookOpen, Target, Lightbulb, TrendingUp } from 'lucide-react';
import { Card, CardHeader, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Separator } from '@/components/ui/separator';

const CatKomatsuPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50">
        ...
        <div className="relative container mx-auto px-4 py-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-yellow-100 mb-8 leading-relaxed">
              Spécialisez-vous dans la maintenance des grandes marques d'engins lourds. Formation approfondie sur 
              les procédures spécifiques Caterpillar, Komatsu et Volvo avec leurs outils et diagnostics dédiés.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center bg-white/10 rounded-full px-6 py-3 backdrop-blur-sm">
                <Building className="w-5 h-5 mr-2 text-yellow-200" />
      ...
      {/* Main Content */}
      <main className="flex-1 bg-gradient-to-br from-gray-50 to-yellow-50/30">
                  ...
                  <CardHeader className="bg-gradient-to-r from-yellow-600 to-amber-600 text-white rounded-t-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-yellow-100">Formation spécialisée constructeurs</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-8">
                    <div className="space-y-6">
                      <p className="text-gray-700 text-lg leading-relaxed">
                        Cette formation spécialisée vous forme aux spécificités des trois leaders mondiaux de la construction. 
                        Apprenez les procédures de maintenance propres à chaque constructeur, leurs outils de diagnostic 
                        dédiés et les particularités techniques de leurs gammes d'engins lourds.
                      </p>
                      
                      <div className="grid md:grid-cols-2 gap-6">
                        {[
                          { icon: Factory, title: "Caterpillar (CAT)", desc: "Procédures et outils CAT officiels", color: "text-yellow-600" },
                          { icon: Building, title: "Komatsu", desc: "Techniques de maintenance Komatsu", color: "text-amber-600" },
                          { icon: TrendingUp, title: "Volvo CE", desc: "Systèmes et diagnostic Volvo", color: "text-orange-600" },
                          { icon: Wrench, title: "Comparaison Constructeurs", desc: "Différences et similitudes", color: "text-yellow-700" }
                        ].map((item, index) => (
                ...
                <Card className="border-none shadow-2xl mt-8 overflow-hidden bg-gradient-to-br from-white to-orange-50/50">
                  ...
                  <CardContent className="p-8">
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6">
                      <div className="space-y-6">
                        {[
                          { week: "Semaine 1", topic: "Maintenance Caterpillar", details: "Procédures CAT, outils ET et spécificités" },
                          { week: "Semaine 2", topic: "Maintenance Komatsu", details: "Systèmes Komatsu et diagnostic KOMTRAX" },
                          { week: "Bonus", topic: "Maintenance Volvo CE", details: "Technologies Volvo et outils CareTrack" },
                          { week: "Pratique", topic: "Comparaison et optimisation", details: "Analyse comparative et meilleures pratiques" }
                        ].map((module, index) => (
                  ...
                  <CardHeader className="bg-gradient-to-br from-yellow-600 to-amber-600 text-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-yellow-100">Constructeurs</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-gray-700">Certification Caterpillar</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span className="text-sm text-gray-700">Certification Komatsu</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span className="text-sm text-gray-700">Certification Volvo CE</span>
                      </div>
                    </div>
                    <Separator className="bg-gradient-to-r from-yellow-200 to-amber-200 my-4" />
                    <div className="text-center">
                      <p className="text-sm text-gray-600 mb-4">
                        Devenez expert multi-marques
                      </p>
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Maîtrisez les leaders du marché</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-orange-600 mt-0.5 flex-shrink-0" />
                        <span>Accédez aux outils constructeurs</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-orange-600 mt-0.5 flex-shrink-0" />
                        <span>Optimisez vos interventions</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-orange-600 mt-0.5 flex-shrink-0" />
                        <span>Devenez technicien spécialisé</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
